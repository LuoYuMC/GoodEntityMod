...
public class LuoYuWolfModel extends AdvancedHumanoidModel<LuoYuWolfEntity> {
    ...
    private final HumanoidAnimator<LuoYuWolfEntity, LuoYuWolfModel> animator;

    public LuoYuWolfModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = RightCheek.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(85, 37).mirror().addBox(-0.45F, -1.0F, -1.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.85F, -5.5F, -0.8F, 0.5995F, -0.2317F, -0.3404F));
		...
		PartDefinition cube_r4 = LeftCheek.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(91, 37).addBox(0.45F, -1.0F, -1.0F, 0.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.85F, -5.5F, -0.8F, 0.5995F, 0.2317F, 0.3404F));
		...
		PartDefinition fur_r1 = RightArm.addOrReplaceChild("fur_r1", CubeListBuilder.create().texOffs(66, -2).mirror().addBox(-0.45F, -2.0F, -1.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.15F, 0.7F, -0.4F, 0.1459F, -0.6959F, -0.0246F));
		...
		PartDefinition fur_r2 = LeftArm.addOrReplaceChild("fur_r2", CubeListBuilder.create().texOffs(66, -2).addBox(0.45F, -2.0F, -1.0F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.15F, 0.7F, -0.4F, 0.1459F, 0.6959F, 0.0246F));
		...
		PartDefinition LeftArmFur = LeftArm.addOrReplaceChild("LeftArmFur", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition LeftHandFur = LeftArmFur.addOrReplaceChild("LeftHandFur", CubeListBuilder.create(), PartPose.offset(2.0F, 7.5F, -2.3F));

		PartDefinition LeftArmFur_r1 = LeftHandFur.addOrReplaceChild("LeftArmFur_r1", CubeListBuilder.create().texOffs(0, 71).mirror().addBox(-1.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)).mirror(false), PartPose.offsetAndRotation(-3.3F, 0.0F, 3.3F, 0.0F, 1.5708F, -0.0873F));

		PartDefinition LeftArmFur_r2 = LeftHandFur.addOrReplaceChild("LeftArmFur_r2", CubeListBuilder.create().texOffs(0, 66).addBox(-3.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(1.3F, 0.0F, 3.3F, 0.0F, -1.5708F, 0.0873F));

		PartDefinition LeftArmFur_r3 = LeftHandFur.addOrReplaceChild("LeftArmFur_r3", CubeListBuilder.create().texOffs(0, 61).addBox(-3.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.0F, 3.6F, -0.0873F, 0.0F, 0.0F));

		PartDefinition LeftArmFur_r4 = LeftHandFur.addOrReplaceChild("LeftArmFur_r4", CubeListBuilder.create().texOffs(0, 56).addBox(-3.0F, -3.0F, 0.025F, 4.0F, 4.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
    ...
    @Override
    public void prepareMobModel(LuoYuWolfEntity entity, float limbSwing, float limbSwingAmount, float partialTicks) {
        super.prepareMobModel(entity, limbSwing, limbSwingAmount, partialTicks);
    }

    public void setupHand(LuoYuWolfEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull LuoYuWolfEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<LuoYuWolfEntity, LuoYuWolfModel> getAnimator(LuoYuWolfEntity entity) {
        return animator;
    }
}
