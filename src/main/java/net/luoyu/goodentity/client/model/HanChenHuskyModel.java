...
public class HanChenHuskyModel extends AdvancedHumanoidModel<HanChenHuskyEntity> {
    ...
    private final HumanoidAnimator<HanChenHuskyEntity, HanChenHuskyModel> animator;

    public HanChenHuskyModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(HanChenHuskyEntity entity, float limbSwing, float limbSwingAmount, float partialTicks) {
        super.prepareMobModel(entity, limbSwing, limbSwingAmount, partialTicks);
    }

    public void setupHand(HanChenHuskyEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull HanChenHuskyEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<HanChenHuskyEntity, HanChenHuskyModel> getAnimator(HanChenHuskyEntity entity) {
        return animator;
    }
}
